...
//import { migrateCart } from '@/utils/migrateCart';
...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/oauth2/authorize/google`);
            toast.dismiss();
        ...
        <main className="min-h-screen flex items-center justify-center bg-background dark:bg-dark-background text-text-primary dark:text-dark-text-primary">
            ...
            >
                ...
                <button
                    ...
                    className="w-full mt-4 py-2 font-bold bg-accent text-white rounded hover:opacity-90"
                >
                    Google 로그인
                </button>
            </form>
